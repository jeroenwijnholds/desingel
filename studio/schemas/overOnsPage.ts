...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      description: 'Klein label boven de introtitel, bijv. "Victor & Mari Duurland".',
    }),
    ...
    defineField({
      ...
      type: 'array',
      of: [{ type: 'string' }],
      description: 'De twee korte regels met icoontje onder de introtekst, bijv. "Achterhoek, Gelderland".',
    ...
    defineField({
      ...
      type: 'string',
      description: 'Klein label boven de verhaaltitel, bijv. "Ons verhaal".',
    }),
    ...
    defineField({
      name: 'valuesLabel',
      title: 'Waarden kop-label',
      type: 'string',
      description: 'Klein label boven de waardensectie, bijv. "Waar wij voor staan".',
    }),
    defineField({ name: 'valuesTitle', title: 'Waarden titel', type: 'string' }),
    defineField({
      name: 'values',
      title: 'Waarden (max 3)',
      type: 'array',
